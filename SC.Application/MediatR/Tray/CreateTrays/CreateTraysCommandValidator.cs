...
public class CreateTraysCommandValidator : AbstractValidator<CreateTraysCommand>
{
    private const int MaxBulk = 100;

    public CreateTraysCommandValidator()
    {
        // Đơn lẻ: Code. Hàng loạt: Prefix + From + To. Phải có 1 trong 2 kiểu.
        RuleFor(x => x)
