...
{
    Task<Result> FinalizeAsync(Guid sessionId, List<(Guid DishId, int PreparedQuantity)> preparedDishes, Guid managerId, CancellationToken cancellationToken = default);
